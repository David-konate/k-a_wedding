  ...
  return (
    <main className="min-h-screen bg-[#fdf6f0] text-[#3a2e2e]">
      ...
      <section className="relative flex flex-col items-center justify-center text-center py-32 px-6 overflow-hidden bg-[#fdf6f0]">
        ...
        <p className="font-[family-name:var(--font-vibes)] text-[#b8735a] text-2xl mb-4 tracking-wide">
        ...
        <p className="font-[family-name:var(--font-playfair)] text-[#b8735a] text-lg tracking-[0.3em] uppercase mt-4 mb-8">
          05 · 01 · 2026
        </p>
        ...
        <p className="font-[family-name:var(--font-playfair)] text-lg text-[#6b5b52] max-w-2xl leading-relaxed mt-4">
          {t("hero.intro")}
        </p>
        <p className="font-[family-name:var(--font-playfair)] mt-4 text-[#8c7b72] max-w-xl leading-relaxed text-base italic">
          {t("hero.subtitle")}
        </p>
      </section>
      ...
      <section className="flex items-center justify-center py-12 px-6 bg-white">
        <div className="w-full max-w-3xl h-96 bg-[#f0e8e2] rounded-none flex items-center justify-center border border-[#e0d0c8]">
          <span className="text-[#b8a09a] font-[family-name:var(--font-playfair)] text-lg tracking-widest uppercase text-sm">
            Photo
          </span>
        </div>
      </section>
      ...
      <section className="py-20 px-6 max-w-3xl mx-auto">
        <div className="text-center mb-12">
          <p className="font-[family-name:var(--font-vibes)] text-[#b8735a] text-2xl mb-2">
        ...
        <div className="space-y-4">
          {[
            ...
            >
              <h3 className="font-[family-name:var(--font-cormorant)] font-semibold text-[#3a2e2e] text-lg mb-2">
                {q}
              </h3>
              <p className="font-[family-name:var(--font-playfair)] text-[#6b5b52] leading-relaxed text-sm">
                {a}
              </p>
            </div>
          ))}
      ...
      <section className="flex items-center justify-center py-12 px-6 bg-white">
        <div className="w-full max-w-3xl h-96 bg-[#f0e8e2] rounded-none flex items-center justify-center border border-[#e0d0c8]">
          <span className="text-[#b8a09a] font-[family-name:var(--font-playfair)] text-sm tracking-widest uppercase">
            Photo
          </span>
        </div>
      </section>
      ...
      <section className="py-20 px-6 max-w-3xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <p className="font-[family-name:var(--font-playfair)] text-[#8c7b72] leading-relaxed text-sm italic border-l-2 border-[#b8735a] pl-4">
          ...
          <div className="bg-white border border-[#e8ddd8] rounded-sm p-6 shadow-sm">
            <h3 className="font-[family-name:var(--font-cormorant)] font-semibold text-[#3a2e2e] text-xl mb-4">
            ...
            <ul className="space-y-2">
              {(["0", "1", "2", "3"] as const).map((i) => (
                <li
                  key={i}
                  className="flex items-start gap-3 font-[family-name:var(--font-playfair)] text-[#6b5b52] text-sm"
                >
      ...
      <section className="py-20 px-6 bg-[#f5ece6]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="font-[family-name:var(--font-playfair)] text-[#8c7b72] italic text-lg">
      ...
      <section className="py-20 px-6 bg-[#3a2e2e] text-white">
        <div className="max-w-3xl mx-auto text-center">
          <p className="font-[family-name:var(--font-vibes)] text-[#b8735a] text-3xl mb-6">
            {t("quote.title")}
          </p>
          ...
          <blockquote className="font-[family-name:var(--font-cormorant)] text-[#c9b8b0] italic leading-relaxed text-xl font-light">
            {t("quote.text")}
          </blockquote>
          <p className="mt-8 font-[family-name:var(--font-vibes)] text-[#b8735a] text-2xl">
            {t("quote.authors")}
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="font-[family-name:var(--font-playfair)] text-[#6b5b52] mb-2 text-sm">
            {t("contact.intro")}
          </p>
          <p className="font-[family-name:var(--font-vibes)] text-[#3a2e2e] text-3xl mb-8">
            {t("contact.names")}
          </p>
          <div className="flex items-center justify-center gap-4 mb-8">
          ...
          <div className="space-y-3 font-[family-name:var(--font-playfair)] text-[#6b5b52] text-sm">
            <p>📧 {t("contact.email")}</p>
      ...
      <footer className="py-10 text-center bg-[#3a2e2e]">
        ...
        <p className="font-[family-name:var(--font-playfair)] text-[#8c7b72] text-xs tracking-widest uppercase">
